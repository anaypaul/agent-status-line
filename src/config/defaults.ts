...
export const DEFAULT_CONFIG: Config = {
  ...
  agents: {
    ...
    'directory': { enabled: true, position: 4, options: { shorten: true, max_length: 30 } },
    'cost': { enabled: true, position: 5, options: { show_lines: true } },
    'git': { enabled: true, position: 6, options: { max_branch_length: 20 } },
    'agent-info': { enabled: true, position: 7, options: {} },
